        ...
        <div className="relative min-h-screen flex items-center justify-center pt-20 pb-12 px-4 overflow-hidden">
            ...
            >
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h1 className="text-xl md:text-2xl font-bold text-slate-800">Reset Password</h1>
                ...
                {!isSuccess ? (
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            className="w-full flex items-center justify-center gap-2 py-4 rounded-xl text-sm font-bold text-white transition-all duration-200 shadow-lg bg-purple-600 hover:bg-purple-700 shadow-purple-500/20"
                        >
                            Update Password
                        </button>
                    </form>
