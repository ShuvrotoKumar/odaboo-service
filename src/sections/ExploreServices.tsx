    ...
    <section className="py-24 bg-white">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 min-h-[600px]">
          {/* Main Large Card */}
          <Link href="/services" className="md:col-span-2 md:row-span-2 block">
            <motion.div
              initial={{ opacity: 0, scale: 0.95 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              className="h-full group relative overflow-hidden rounded-[--radius-premium] shadow-xl"
            >
              <Image
          ...
          {/* Top Right Card */}
          <Link href="/services" className="md:col-span-2 block">
            <motion.div
              initial={{ opacity: 0, scale: 0.95 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              transition={{ delay: 0.1 }}
              className="h-full group relative overflow-hidden rounded-[--radius-premium] shadow-lg min-h-[280px]"
            >
              <Image
